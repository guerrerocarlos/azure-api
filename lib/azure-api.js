...
function runAzureCmd(args) {
  ...
  return regeneratorRuntime.async(function runAzureCmd$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 4:
        azureCmd = _path2['default'].join(_npm2['default'].bin, 'azure');
        spawnOptions = {
        ...
        context$1$0.prev = 7;
        output = (0, _childProcessPromise.spawn)(azureCmd, args, spawnOptions);
  ...
  return regeneratorRuntime.async(function deleteCluster$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        args = ['hdinsight', 'cluster', 'delete', clOptions.clusterName, '--osType', clOptions.osType, '--location', clOptions.location, '--storageAccountName', clOptions.storageAccountName, '--storageAccountKey', clOptions.storageAccountKey, '--json'];
        context$1$0.next = 14;
        return regeneratorRuntime.awrap(runAzureCmd(args));
